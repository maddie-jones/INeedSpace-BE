...
describe 'Favorites API' do
  it 'should return all favorites' do
    favorite_1 = Favorite.create(title: "star_1", url: "star_img_1.com", hdurl: "star_img_hd_1", explanation: "good photo of star 1")
    favorite_2 = Favorite.create(title: "star_2", url: "star_img_2.com", hdurl: "star_img_hd_2", explanation: "good photo of star 2")
